  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      if (e.key === "ArrowRight" && nextTopic) {
        ...
        router.push(`/topics/${prevTopic.id}`);
      }
    };
    window.addEventListener("keydown", handleKeyDown);
    return () => window.removeEventListener("keydown", handleKeyDown);
  }, [nextTopic?.id, prevTopic?.id, router]);
  ...
  return (
    <div style={{ background: "#070711", minHeight: "100vh", color: "#fff" }}>
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "100px 24px 60px" }}>
        ...
        {/* Topic Navigation Section (Previous / All Topics / Next) */}
        <div style={{ marginTop: "48px", display: "flex", gap: "16px", flexWrap: "wrap", alignItems: "stretch" }}>
          {prevTopic ? (
            <Link
            ...
            >
              ...
              <span style={{ fontSize: "1rem", color: "#fff", fontWeight: 800 }}>
          ...
          {nextTopic && (
            ...
            >
              <span style={{ fontSize: "0.75rem", color: "#c4b5fd", fontWeight: 700, letterSpacing: "0.5px" }}>
                NEXT TOPIC →
              </span>
              <span style={{ fontSize: "1rem", color: "#fff", fontWeight: 800 }}>
        ...
        {/* Share Section */}
        <div style={{ marginTop: "40px", textAlign: "center", borderTop: "1px solid rgba(255,255,255,0.05)", paddingTop: "32px", display: "flex", justifyContent: "center", gap: "12px", flexWrap: "wrap" }}>
          <Link
            href="/"
            style={{
